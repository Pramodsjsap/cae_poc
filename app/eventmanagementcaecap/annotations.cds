...
annotate EventManager.Events with @(UI : {
    SelectionFields                  : [
        identifier,
        date,
    ...
    HeaderFacets                     : [
        ...
        {
            $Type  : 'UI.ReferenceFacet',
            Target : '@UI.DataPoint#EventStatus'
        },
        {
            $Type  : 'UI.ReferenceFacet',
    ...
    FieldGroup #Values               : {Data : [
        ...
        },
        {
            $Type : 'UI.DataField',
            Value : date,
            Label : '{i18n>eventDate}'
        },
        {
            $Type : 'UI.DataField',
            Value : maxParticipantsNumber,
            Label : '{i18n>maximumAllowedParticipants}'
        },
        {
            $Type : 'UI.DataField',
            Value : availableFreeSlots,
...
annotate EventManager.Participants with @(UI : {
    SelectionFields                : [
        identifier,
        email,
        mobileNumber,
    ...
    LineItem                       : [
        ...
        },
        {
            ...
            Action : 'EventManager.cancelParticipation'
        },
        {
            $Type             : 'UI.DataField',
            Value             : identifier,
